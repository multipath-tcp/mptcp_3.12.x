...
void __init mptcp_init(void)
{
	...
	pr_info("MPTCP: release for 3.12 series, v0.88.13 EOL!");
	pr_warn("MPTCP: This version is unsupported at this moment!"
		" Please consider updating to MPTCP 0.89.1 or higher!");
